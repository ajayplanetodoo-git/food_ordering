# Generated by Django 4.2.26 on 2026-01-09 10:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vendor_app', '0004_alter_vendor_vendor_slug'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day', models.IntegerField(choices=[(1, 'Monday'), (2, 'Tuesday'), (3, 'Wednesday'), (4, 'Thurstday'), (5, 'Friday'), (6, 'saturday'), (7, 'Sunday')])),
                ...
                ('vendor', models.ForeignKey(on_delete=django.db.models.expressions.Case, to='vendor_app.vendor')),
            ],
            options={
